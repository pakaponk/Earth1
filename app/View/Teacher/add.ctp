<h3 style="padding: 10px;margin-left: 50px;margin-right: 50px;border-bottom: 1px solid #e5e5e5">Add Teacher to Classroom</h3>
...
<div style="padding: 10px;width: 800px;margin: 0px auto;">
    ...
    echo $this->Form->submit('Add Teacher',array(
